...
// failed, it would come back empty and wipe the order history on the next save.
...
exports.handler = async (event) => {
  ...
  if (!process.env.SUPABASE_SERVICE_ROLE_KEY) {
    return { statusCode: 500, body: JSON.stringify({ error: "Server not configured yet — missing service role key." }) };
  }
