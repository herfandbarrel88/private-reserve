...
exports.handler = async (event) => {
  ...
  try {
    ...
    let subtotal = 0;       // built from verified prices, used to work out delivery
    ...
    // Delivery was being shown to the customer but never added to the Stripe
    // session, so card orders collected nothing for it and recorded as free.
    // Same thresholds the app and the bank-transfer function already use.
